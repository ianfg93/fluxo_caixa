...
// PATCH - Atualizar quantidade de um item da comanda
  ...
  try {
    ...
    try {
      ...
      const updateResult = await query(
        `UPDATE open_order_items
         SET quantity = $1::integer, subtotal = product_price * $1::numeric
         WHERE id = $2::uuid AND order_id = $3::uuid`,
        [quantity, params.itemId, params.id]
      )
